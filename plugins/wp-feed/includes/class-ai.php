...
final class Ai {
	...
	private const CACHE_PREFIX = 'wp_feed_ai_cache_';
	private const CACHE_TTL    = DAY_IN_SECONDS;
	private const DAILY_KEY    = 'wp_feed_ai_count_today';
	private const SYSTEM_PROMPT = "You are an expert ecommerce copywriter optimizing product titles for shopping channels. Output ONLY the requested title text with no preamble, no quotes, no markdown, no explanation. Be factual; never invent specs.";
