...
final class Ai {
	...
	private const CACHE_PREFIX = 'wp_forms_ai_cache_';
	private const CACHE_TTL    = DAY_IN_SECONDS;
	private const DAILY_KEY    = 'wp_forms_ai_count_today';
	...
	public static function test(): array {
		$client = new self();
		$result = $client->complete( 'Reply with the single word: ok.', array( 'max_tokens' => 10, 'temperature' => 0.0 ) );
		return $result;
	}
