            ...
            <BlockStack gap="400">
              <BlockStack gap="100">
                ...
                <Text as="p" tone="subdued">
                  Klyna Urgency's countdown timers, scarcity rules, and social proof work
                  without AI. To draft optional dynamic copy from live inventory and recent
                  sales, add a free-tier API key below. Your key stays on this app's database.
                </Text>
              </BlockStack>
          ...
          <Card>
            <BlockStack gap="200">
              ...
              <Text as="p" tone="subdued" variant="bodyMd">
                Klyna Urgency is part of the Klyna indie suite. Countdown timers, low-stock
                scarcity, and social-proof popups work without AI. AI is optional and only
                used to draft dynamic scarcity copy from your real inventory and recent sales.
              </Text>
              <Box>
