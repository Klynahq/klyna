...
export default function Auth() {
  ...
  const errors = (actionData?.errors ?? loaderData.errors) as
  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <h1>Install Klyna Bundles</h1>
        <p className="subtitle">
          Connect your Shopify store to create product bundles, quantity
          breaks, and storefront offers.
        </p>
        ...
        <p className="footer-note">
          Klyna Bundles is free to install for development stores.
        </p>
      </div>
    </>
  );
