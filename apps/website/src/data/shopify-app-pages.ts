...
export const shopifyProductPages: ShopifyProductPage[] = [
  {
    ...
    reviewNotes: [
      ...
      'Theme cleanup uses backup, preview, and rollback language.',
    ],
    guideUrl: '/blog/shopify-leftover-app-code-cleanup',
  },
  {
    slug: 'promo-qa',
    name: 'Klyna Promo QA',
    ...
    guideUrl: '/blog/shopify-promo-qa-checklist',
  },
  {
    slug: 'redirect-guard',
    ...
    reviewNotes: [
      ...
      'Bulk write actions stay explicit and previewed.',
      'Avoids claiming ranking guarantees.',
    ],
    guideUrl: '/blog/shopify-redirect-monitoring-app',
  ...
  },
  {
    ...
    guideUrl: '/blog/shopify-pixel-qa-checklist',
  },
  {
    slug: 'feed-doctor',
    name: 'Klyna Feed Doctor',
    eyebrow: 'Catalog readiness for Merchant Center',
    description:
    ...
    guideUrl: '/blog/shopify-feed-quality-checklist',
  },
];
